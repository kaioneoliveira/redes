...
def topology():
    ...
    ap1 = net.addAccessPoint('ap1', ssid="ponto1", isolate_clientes=True, mode="g", channel="5", position='75,50,0')
    ap2 = net.addAccessPoint('ap2', ssid="ponto2", isolate_clientes=True, mode="g", channel="5", position='60,60,0')
